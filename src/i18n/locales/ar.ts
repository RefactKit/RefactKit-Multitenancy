...
export const ar: Translations = {
  ...
  landing: {
    ...
    hero: {
      badge: 'RefactKit — مؤسسة SaaS الحديثة',
      title: 'ابنِ مشروعك على أساس متين',
      subheading:
        'RefactKit هو نموذج SaaS عالي الأداء مبني باستخدام TanStack Start و Better Auth و Drizzle ORM. مصمم للتطبيقات متعددة المستأجرين.',
      getStarted: 'ابدأ الآن',
    ...
    techStack: {
      title: 'مبني بأفضل التقنيات',
      subtitle: 'تم بناء RefactKit على أدوات حديثة وموثوقة لضمان سرعة وأمان وقابلية توسع مشروعك.',
    },
    dashboard: {
      title: 'واجهة لوحة تحكم قوية',
      subtitle:
        'قم بإدارة منظماتك وأعضائك ومواردك من خلال لوحة تحكم متميزة عالية الأداء مبنية باستخدام React 19 و TanStack Start.',
    },
    detailedFeatures: {
