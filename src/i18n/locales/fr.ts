...
export const fr: Translations = {
  ...
  landing: {
    ...
    dashboard: {
      title: 'Interface de Tableau de Bord Puissante',
      subtitle:
        'Gérez vos organisations, membres et ressources avec un tableau de bord premium et haute performance construit avec React 19 et TanStack Start.',
    },
    detailedFeatures: {
