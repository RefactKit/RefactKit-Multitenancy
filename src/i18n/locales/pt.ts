...
export const pt: Translations = {
  ...
  lang: { en: 'EN', fr: 'FR', ar: 'AR', es: 'ES', pt: 'PT' },
  auth: {
    login: {
      badge: 'Login seguro',
  ...
  landing: {
    ...
    hero: {
      badge: 'RefactKit — A Fundação SaaS Moderna',
      title: 'Construa seu SaaS com uma base sólida',
      subheading:
        'RefactKit é um boilerplate SaaS de alto desempenho construído com TanStack Start, Better Auth e Drizzle ORM. Projetado para aplicações multi-tenant.',
      getStarted: 'Começar',
    ...
    techStack: {
      title: 'Construído com as melhores tecnologias',
      subtitle:
        'O RefactKit é construído sobre ferramentas modernas e testadas para garantir que seu SaaS seja rápido, seguro e escalável.',
    },
    dashboard: {
      title: 'Interface de Painel Poderosa',
      subtitle:
        'Gerencie suas organizações, membros e recursos com um painel premium de alto desempenho construído com React 19 e TanStack Start.',
    },
    detailedFeatures: {
