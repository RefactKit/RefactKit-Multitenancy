...
| **i18n** | Personnalisé (basé sur i18next) | — | 10 langues (EN, FR, ES, PT, AR, AR-MA, BE, DE, HI, ZH). Support RTL. Persistance de la locale par cookie. Détection de la locale côté serveur. |
